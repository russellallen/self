...
p* = lobby.
doit = (
| dir. prev. next.  args. fileCount. startPt. showPt. stageRightPt. whiteSheet. spewer. banner. outliner |
...
\"Make new currentMph and pull it on screen...\"
 ...
 lines doFirst: [ | :line.  |
    currentMph: (labelMorph copyLabel: line) fontSpec: globals fontSpec copyName: \'Times\' Size: 14.
   ...
   (line size = 1) && [line first = \'.\'] ifTrue: [
     ...
     mph: (labelMorph copyLabel: line) fontSpec: globals fontSpec copyName: \'Times\' Size: 14.
...
"Create an outliner on an empty object."
outliner: process this birthEvent sourceHand world outlinerForMirror: reflect: ().
outliner globalPosition: 1925 @ -675.
process this birthEvent sourceHand world addMorph: outliner.
