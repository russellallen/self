...
( root ) hResizing: 0.
( root ) rawBox: ((329)@(558)) # ((375)@(651)).
( root ) rawColor: paint named: 'black'.
( root ) vResizing: 0.
( root ) borderWidth: 2.
( root ) dragPoint: (329)@(558).
...
( root rawMorphs at: 0 ) rawBox: ((13)@(59)) # ((33)@(73)).
...
( root rawMorphs at: 1 ) rawBox: ((13)@(37)) # ((33)@(51)).
...
( root rawMorphs at: 2 ) rawBox: ((13)@(16)) # ((33)@(30)).
...
( (root rawMorphs at: 0) rawMorphs at: 0 ) position: (0)@(14).
...
( (root rawMorphs at: 1) rawMorphs at: 0 ) position: (0)@(14).
...
( (root rawMorphs at: 2) rawMorphs at: 0 ) position: (0)@(14).
