...
( root ) hResizing: 0.
( root ) rawBox: ((503)@(170)) # ((645)@(218)).
( root ) rawColor: paint named: 'black'.
( root ) vResizing: 0.
( root ) borderWidth: 2.
( root ) dragPoint: (503)@(170).
...
( root rawMorphs at: 0 ) rawBox: ((74)@(10)) # ((88)@(30)).
...
( root rawMorphs at: 1 ) rawBox: ((52)@(10)) # ((66)@(30)).
...
( root rawMorphs at: 2 ) rawBox: ((32)@(10)) # ((46)@(30)).
...
( (root rawMorphs at: 0) rawMorphs at: 0 ) position: (0)@(0).
...
( (root rawMorphs at: 1) rawMorphs at: 0 ) position: (0)@(0).
...
( (root rawMorphs at: 2) rawMorphs at: 0 ) position: (0)@(0).
