...
( root ) hResizing: 0.
( root ) rawBox: ((917)@(-1441)) # ((1559)@(-1072)).
( root ) rawColor: paint named: 'black'.
( root ) vResizing: 0.
( root ) borderWidth: 2.
( root ) dragPoint: (917)@(-1441).
...
( root rawMorphs at: 0 ) myBox: ((32)@(7)) # ((32)@(22)).
...
( root rawMorphs at: 0 ) myPosition: (32)@(19).
...
( (((root rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0 ) myLabel: 'Self application, and you can have fun taking apart or re-arranging' copyMutable.
...
( ((((root rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0 ) myLabel: 'the resulting pages using the \"direct construction\" techniques' copyMutable.
...
[
" State for: a labelMorph(type: labelMorph [as described in the tutorial below (9 clicks down on your radar view\n]): "
...
( (((((root rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0 ) myLabel: 'as described in the tutorial below (9 clicks down on your radar view
' copyMutable.
...
( (((((((root rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0 ) myLabel: '     The web browser is available at anytime from the Self background' copyMutable.
...
( ((((((((root rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0 ) myLabel: 'middle button menu - select \"Web hostlist,\" then use the middle button' copyMutable.
