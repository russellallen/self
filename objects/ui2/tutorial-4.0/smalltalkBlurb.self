...
[
" State for: a labelMorph(type: labelMorph [    This is only a partial Smalltalk implementation. Please see the documentation\n]): "

( root ) hResizing: 0.
( root ) myAscent: 11.
( root ) myBox: ((306)@(-172)) # ((803)@(-158)).
( root ) myDescent: 3.
( root ) myFontSpec: fontSpec copyName: 'times' Size: 14 Style: 'bold' copyMutable.
...
[
" State for: a labelMorph(type: labelMorph [\"Self 4.0 Smalltalk Emulator\" for a full discussion of its limitations.\n]): "
...
( root rawMorphs at: 0 ) myWidth: 421.
( root rawMorphs at: 0 ) rawColor: paint named: 'black'.
( root rawMorphs at: 0 ) vResizing: 0.
] value.

[
" State for: a labelMorph(type: labelMorph [    We hope this demonstrates that a prototype-based language like Self can\n]): "
...
( (root rawMorphs at: 0) rawMorphs at: 0 ) myFontSpec: fontSpec copyName: 'times' Size: 14 Style: 'bold' copyMutable.
...
( (root rawMorphs at: 0) rawMorphs at: 0 ) myWidth: 466.
( (root rawMorphs at: 0) rawMorphs at: 0 ) rawColor: paint named: 'black'.
( (root rawMorphs at: 0) rawMorphs at: 0 ) vResizing: 0.
] value.

[
" State for: a labelMorph(type: labelMorph [provide, in a fairly direct way, the functionality of a class-based system.\n]): "
...
( ((root rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0 ) myFontSpec: fontSpec copyName: 'times' Size: 14 Style: 'bold' copyMutable.
...
( ((root rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0 ) myWidth: 441.
...
[
" State for: a labelMorph(type: labelMorph [    We encourage Smalltalk programmers to try some of their code!]): "
...
( (((root rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0) rawMorphs at: 0 ) myFontSpec: fontSpec copyName: 'times' Size: 14 Style: 'bold' copyMutable.
