...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'traits' -> 'xlib' -> () From: ( | {
         ...
         xftFont = bootstrap setObjectAnnotationOf: bootstrap stub -> 'traits' -> 'xlib' -> 'xftFont' -> () From: ( |
             {} = 'Comment: `XftFont` is a public interface.  Its real implementation
subclass is private to libXft with references obtained via
`XftFontOpen*` factory methods and released with `XftFontClose`.
Hence no `new` and `delete`.\x7fModuleInfo: Creator: traits xlib xftFont.
'.
            | ) .
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'traits' -> 'xlib' -> 'xftDraw' -> () From: ( | {
         'Comment: TODO: primitiveMaker currently doesn\'t automatically
kill the proxy if `delete` is done with a custom call.\x7fModuleInfo: Module: xlib InitialContents: FollowSlot\x7fVisibility: public'
...
that also kills the receiver like a plain `delete` would.\x7fModuleInfo: Module: xlib InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'traits' -> 'xlib' -> 'xftFont' -> () From: ( | {
         'Category: printing\x7fModuleInfo: Module: xlib InitialContents: FollowSlot\x7fVisibility: public'
