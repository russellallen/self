...
# define byteVector_glue                                                                                                                                 \
  ...
  CC_mber_8(oop,,         oop,byteVector,      run_native_passing_prim, run_native_passing_prim_glue,, oop,byteVector, oop,byteVector, oop,byteVector, oop,byteVector, oop,byteVector, oop,byteVector, oop,byteVector, oop,byteVector ) \
