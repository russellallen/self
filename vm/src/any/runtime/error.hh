...
# define error1(m, x1)                                                        \
   lprint_error(m, (void*)(x1))

# define error2(m, x1, x2)                                                    \
   lprint_error(m, (void*)(x1), (void*)(x2))

# define error3(m, x1, x2, x3)                                                \
   lprint_error(m, (void*)(x1), (void*)(x2), (void*)(x3))

# define error4(m, x1, x2, x3, x4)                                            \
   lprint_error(m, (void*)(x1), (void*)(x2), (void*)(x3), (void*)(x4))
...
# define warning1(m, x1)                                                      \
   lprint_warning(m, (void*)(x1))

# define warning2(m, x1, x2)                                                  \
   lprint_warning(m, (void*)(x1), (void*)(x2))

# define warning3(m, x1, x2, x3)                                              \
   lprint_warning(m, (void*)(x1), (void*)(x2), (void*)(x3))

# define warning4(m, x1, x2, x3, x4)                                          \
   lprint_warning(m, (void*)(x1), (void*)(x2), (void*)(x3), (void*)(x4))
...
# define fatal1(m, x1)                                                        \
    lprint_fatal(__FILE__, __LINE__, m, (void*)(x1))

# define fatal2(m, x1, x2)                                                    \
    lprint_fatal(__FILE__, __LINE__, m, (void*)(x1), (void*)(x2))

# define fatal3(m, x1, x2, x3)                                                \
    lprint_fatal(__FILE__, __LINE__, m, (void*)(x1), (void*)(x2), (void*)(x3))
...
# define fatal9(m, x1, x2, x3, x4, x5, x6, x7, x8, x9)                        \
    lprint_fatal(__FILE__, __LINE__, m, (void*)(x1), (void*)(x2), (void*)(x3),\
                                        (void*)(x4), (void*)(x5), (void*)(x6),\
                                        (void*)(x7), (void*)(x8), (void*)(x9))

# define fatalNoMenu(m)                                                       \
    lprint_fatalNoMenu(__FILE__, __LINE__, m)
# define fatalNoMenu1(m, x1)                                                  \
    lprint_fatalNoMenu(__FILE__, __LINE__, m, (void*)(x1))

# define fatalNoMenu2(m, x1, x2)                                              \
    lprint_fatalNoMenu(__FILE__, __LINE__, m, (void*)(x1), (void*)(x2))
