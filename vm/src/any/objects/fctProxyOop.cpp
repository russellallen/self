...
#define SETUP(vars)                                           \
    oop (*fct)(vars);                                        \
    fct = (oop (*)(vars)) foreignOopClass::get_pointer();
#else
#define SETUP(vars)                                           \
    __cdecl oop (*fct)(vars);                                \
    fct = (oop (*)(vars)) foreignOopClass::get_pointer();
#endif
...
oop fctProxyOopClass::run0_prim(void *FH) {
    GUARD(0)
    SETUP(oop COMMA void*[] COMMA void*)
    RUN(this COMMA useful_array_of_functions COMMA FH)
}

oop fctProxyOopClass::run1_prim(oop arg1, void *FH) {
    GUARD(1)
    SETUP(oop COMMA oop COMMA void*[] COMMA void*)
    RUN(this COMMA arg1 COMMA useful_array_of_functions COMMA FH)
}

oop fctProxyOopClass::run2_prim(oop arg1, oop arg2, void *FH) {
    GUARD(2)
    SETUP(oop COMMA oop COMMA oop COMMA void*[] COMMA void*)
    RUN(this COMMA arg1 COMMA arg2 COMMA useful_array_of_functions COMMA FH)
}

oop fctProxyOopClass::run3_prim(oop arg1, oop arg2, oop arg3, void *FH) {
    GUARD(3)
    SETUP(oop COMMA oop COMMA oop COMMA oop COMMA void*[] COMMA void*)
    RUN(this COMMA arg1 COMMA arg2 COMMA arg3 COMMA useful_array_of_functions COMMA FH)
}
