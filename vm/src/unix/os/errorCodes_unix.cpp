...
# elif  TARGET_OS_VERSION == CYGWIN_VERSION
    ...
    // 41 through 60
    "ELNRNG", "EUNATCH", "ENOCSI", "EL2HLT", "EDEADLK",
    "ENOLCK", "E47-UNUSED", "E48-UNUSED", "E49-UNUSED", "EBADE",
    "EBADR", "EXFULL", "ENOANO", "EBADRQC", "EBADSLT",
    "EDEADLOCK", "EBFONT", "E58-UNUSED", "E59-UNUSED", "ENOSTR", 

    
    // 61 through 80
    "ENODATA", "ETIME", "ENOSR", "ENONET", "ENOPKG",
    "EREMOTE", "ENOLINK", "EADV", "ESRMNT", "ECOMM",
    "EPROTO",  "E72-UNUSED", "E73-UNUSED", "EMULTIHOP", "ELBIN",
    "EDOTDOT", "EBADMSG", "E78-UNUSED", "EFTYPE", "ENOTUNIQ",
    
    // 81 through 100
    "EBADFD", "EREMCHG", "ELIBACC", "ELIBBADD", "ELIBSCN",
    "ELIBMAX", "ELIBEXEC", "ENOSYS", "ENMFILE", "ENOTEMPTY",
    "ENAMETOOLONG", "ELOOP", "E93-UNUSED", "E94-UNUSED", "EOPNOTSUPP",
    "EPFNOSUPPORT", "E97-UNUSED", "E98-UNUSED", "E99-UNUSED", "E100-UNUSED",

    // 101 through 120
    "E101-UNUSED", "E102-UNUSED", "E103-UNUSED", "ECONNRESET", "ENOBUFS",
    "EAFNOSUPPORT", "EPROTOTYPE", "ENOTSOCK", "ENOPROTOOPT", "ESHUTDOWN",
    "ECONNREFUSED", "EADDRINUSE", "ECONNABORTED", "ENETUNREACH", "ENETDOWN",
    "ETIMEDOUT", "EHOSTDOWN", "EHOSTUNREACH", "EINPROGRESS", "EALREADY",

    // 121 through 140
    "EDESTADDRREQ", "EMSGSIZE", "EPROTONOSUPPORT", "ESOCKTNOSUPPORT", "EADDRNOTAVAIL",
    "ENETRESET", "EISCONN", "ENOTCONN", "ETOOMANYREFS", "EPROCLIM",
    "EUSERS", "EDQUOT", "ESTALE", "ENOTSUP",  "ENOMEDIUM", 
    "ENOSHARE", "ECASECLASH", "EILSEQ", "EOVERFLOW", "ECANCELED",

    // 141 through 143
    "ENOTRECOVERABLE", "EOWNERDEAD", "ESTRPIPE"
